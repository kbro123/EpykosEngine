...
**6. Three asymmetries found, all recorded in `bench/compare/README.md` §4 rather than smoothed over.**
  ...
  (c) **Extrapolation beyond the last knot differs.** Inside `[0, last knot]` the two curves are the same
