...
void kernel_4e7edebd795bcae0(double*, ir::value_id, int, int, int, const double* const*, const double* const*,
                    const std::int32_t* const*, const std::int32_t*, const ir::value_id*, const double*);
void kernel_5eaa9e6f7c043d44(double*, ir::value_id, int, int, int, const double* const*, const double* const*,
                    const std::int32_t* const*, const std::int32_t*, const ir::value_id*, const double*);
...
void kernel_bb876e73c39bcfcc(double*, ir::value_id, int, int, int, const double* const*, const double* const*,
                    const std::int32_t* const*, const std::int32_t*, const ir::value_id*, const double*);
void kernel_c61b2b13533b20f7(double*, ir::value_id, int, int, int, const double* const*, const double* const*,
                    const std::int32_t* const*, const std::int32_t*, const ir::value_id*, const double*);
void kernel_d31deacfe6be3160(double*, ir::value_id, int, int, int, const double* const*, const double* const*,
                    const std::int32_t* const*, const std::int32_t*, const ir::value_id*, const double*);
...
void kernel_dd2d4a5510d7a13d(double*, ir::value_id, int, int, int, const double* const*, const double* const*,
                    const std::int32_t* const*, const std::int32_t*, const ir::value_id*, const double*);
void kernel_f3605415bf6c6f8c(double*, ir::value_id, int, int, int, const double* const*, const double* const*,
                    const std::int32_t* const*, const std::int32_t*, const ir::value_id*, const double*);
...
const std::vector<RegistryEntry>& generated_entries() {
  static const std::vector<RegistryEntry> table = {
      ...
      {Signature{{StepShape{Op::Sub, SlotShape::Gather, SlotShape::Gather, SlotShape::None, SlotShape::None, 0, 0, 0, 0}, StepShape{Op::Mul, SlotShape::Column, SlotShape::Step, SlotShape::None, SlotShape::None, 0, 1, 0, 0}}}, "sub(gat,gat);mul(col,step-1)", epykos::catalogue::generated::kernel_5eaa9e6f7c043d44},
      ...
      {Signature{{StepShape{Op::Mul, SlotShape::Gather, SlotShape::Column, SlotShape::None, SlotShape::None, 0, 0, 0, 0}}}, "mul(gat,col)", epykos::catalogue::generated::kernel_c61b2b13533b20f7},
      {Signature{{StepShape{Op::Mul, SlotShape::Gather, SlotShape::Column, SlotShape::None, SlotShape::None, 0, 0, 0, 0}, StepShape{Op::Exp, SlotShape::Step, SlotShape::None, SlotShape::None, SlotShape::None, 1, 0, 0, 0}}}, "mul(gat,col);exp(step-1)", epykos::catalogue::generated::kernel_d31deacfe6be3160},
      ...
      {Signature{{StepShape{Op::Mul, SlotShape::Gather, SlotShape::Literal, SlotShape::None, SlotShape::None, 0, 0, 0, 0}}}, "mul(gat,lit)", epykos::catalogue::generated::kernel_f3605415bf6c6f8c},
